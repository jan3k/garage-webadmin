...
**In early development state**, so external contributions are not currently welcome.

> [!WARNING]
> This software is not ready to use yet. It also makes the use of API endpoints that have not yet to be released.
>
> Do **not** try to use it on your Garage cluster!

![Preview of the dashboard screen](screenshot-dashboard.png)
...
### Fix code linting and formatting

```sh
npm run fix
```

Or if you want to check for problem without auto fix:
...
(_See [Civil Clause](https://en.wikipedia.org/wiki/Civil_clause) on Wikipedia_)
