...
export interface paths {
	"/check": {
		...
		/**
		 * @description Static website domain name check. Checks whether a bucket is configured to serve
	...
	"/health": {
		...
		/**
		 * @description Check cluster health. The status code returned by this function indicates
	...
	"/v2/GetBlockInfo": {
		...
		get?: never
		put?: never
		/** @description Get detailed information about a data block stored on a Garage node, including all object versions and in-progress multipart uploads that contain a reference to this block. */
	...
	"/v2/GetClusterStatistics": {
		...
		/**
		 * @description Fetch global cluster statistics.
		 *
	...
	"/v2/GetNodeStatistics": {
		...
		/**
		 * @description Fetch statistics for one or several Garage nodes.
		 *
		 *     *Note: do not try to parse the `freeform` field of the response, it is given as a string specifically because its format is not stable.*
		 */
	...
	"/v2/InspectObject": {
		...
		/**
		 * @description Returns detailed information about an object in a bucket, including its internal state in Garage.
		 *
	...
	"/v2/ListBlockErrors": {
		...
		/** @description List data blocks that are currently in an errored state on one or several Garage nodes. */
	...
	"/v2/PreviewClusterLayoutChanges": {
		...
		put?: never
		/**
		 * @description Computes a new layout taking into account the staged parameters, and returns it with detailed statistics. The new layout is not applied in the cluster.
		 *
		 *     *Note: do not try to parse the `message` field of the response, it is given as an array of string specifically because its format is not stable.*
		 */
	...
	"/v2/PurgeBlocks": {
		...
		put?: never
		/**
		 * @description Purge references to one or several missing data blocks.
		 *
	...
	"/v2/RetryBlockResync": {
		...
		get?: never
		put?: never
		/** @description Instruct Garage node(s) to retry the resynchronization of one or several missing data block(s). */
	...
	"/v2/SetWorkerVariable": {
		...
		get?: never
		put?: never
		/** @description Set the value for a worker variable, on one or several cluster nodes. */
	...
	"/v2/UpdateAdminToken": {
		...
		get?: never
		put?: never
		/** @description Updates information about the specified admin API token. */
...
export interface components {
	schemas: {
		...
		GetBucketInfoResponse: {
			...
			corsRules?: components["schemas"]["cors.Rule"][] | null
			/**
			 * Format: date-time
			...
			lifecycleRules?: components["schemas"]["lifecycle.Rule"][] | null
			/**
			 * Format: int64
		...
		GetBucketInfoWebsiteResponse: {
			...
			routingRules?: components["schemas"]["website.RoutingRule"][] | null
		}
		...
		LocalGetNodeStatisticsResponse: {
			blockManagerStats?: null | components["schemas"]["NodeBlockManagerStats"]
			/**
			...
			tableStats?: components["schemas"]["NodeTableStats"][] | null
		}
		...
		UpdateClusterLayoutRequest: {
			...
			roles?: components["schemas"]["NodeRoleChangeRequest"][]
		}
		...
		"cors.Rule": {
			...
			ID?: unknown
			MaxAgeSeconds?: null | components["schemas"]["xml.IntValue"]
		}
		"lifecycle.AbortIncompleteMpu": {
			DaysAfterInitiation: components["schemas"]["xml.IntValue"]
		}
		"lifecycle.Expiration": {
			Date?: unknown
			Days?: null | components["schemas"]["xml.IntValue"]
		}
		"lifecycle.Filter": {
			And?: null | components["schemas"]["lifecycle.Filter"]
			ObjectSizeGreaterThan?: null | components["schemas"]["xml.IntValue"]
			ObjectSizeLessThan?: null | components["schemas"]["xml.IntValue"]
			Prefix?: unknown
		}
		"lifecycle.Rule": {
			AbortIncompleteMultipartUpload?: null | components["schemas"]["lifecycle.AbortIncompleteMpu"]
			Expiration?: null | components["schemas"]["lifecycle.Expiration"]
			Filter?: null | components["schemas"]["lifecycle.Filter"]
			ID?: unknown
			Status: unknown
		}
		"website.Condition": {
			HttpErrorCodeReturnedEquals?: null | components["schemas"]["xml.IntValue"]
			KeyPrefixEquals?: unknown
		}
		"website.Redirect": {
			HostName?: unknown
			HttpRedirectCode?: null | components["schemas"]["xml.IntValue"]
			Protocol?: unknown
			ReplaceKeyPrefixWith?: unknown
			ReplaceKeyWith?: unknown
		}
		"website.RoutingRule": {
			Condition?: null | components["schemas"]["website.Condition"]
			Redirect: components["schemas"]["website.Redirect"]
		}
		/** Format: int64 */
		"xml.IntValue": number
	}
...
export interface operations {
	...
	AddBucketAlias: {
		...
		requestBody: {
			content: {
				"application/json": components["schemas"]["BucketAliasEnum"]
			}
		}
		responses: {
